...
//go:generate mockgen -destination=./mock/onboarding.go -package=mock -mock_names=OnboardingKeycloakClient=OnboardingKeycloakClient,KeycloakURIProvider=KeycloakURIProvider github.com/cloudtrust/keycloak-bridge/internal/keycloakb OnboardingKeycloakClient,KeycloakURIProvider

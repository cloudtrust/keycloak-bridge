...
//go:generate mockgen -destination=./mock/db.go -package=mock -mock_names=CloudtrustDB=CloudtrustDB github.com/cloudtrust/common-service/database/sqltypes CloudtrustDB

...
//go:generate mockgen -destination=./mock/security.go -package=mock -mock_names=CrypterDecrypter=CrypterDecrypter github.com/cloudtrust/common-service/security CrypterDecrypter

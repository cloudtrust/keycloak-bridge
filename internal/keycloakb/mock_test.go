...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock/keycloakb.go -package=mock -mock_names=ConfigurationDBModule=ConfigurationDBModule,AccredsKeycloakClient=AccredsKeycloakClient,KeycloakClient=KeycloakClient,KeycloakForTechnicalClient=KeycloakForTechnicalClient,Logger=Logger,HTTPClient=HTTPClient,OnboardingKeycloakClient=OnboardingKeycloakClient,KeycloakURIProvider=KeycloakURIProvider,UsersDBModule=UsersDBModule github.com/cloudtrust/keycloak-bridge/internal/keycloakb ConfigurationDBModule,AccredsKeycloakClient,KeycloakClient,KeycloakForTechnicalClient,Logger,HTTPClient,OnboardingKeycloakClient,KeycloakURIProvider,UsersDBModule

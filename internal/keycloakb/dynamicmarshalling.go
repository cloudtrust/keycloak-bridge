...
//
// This function:
// 1. Marshals the known struct fields (via the DynamicRepresentation interface).
...
//
// The input must be an alias type that implements DynamicRepresentation (see usage note below).
...
// DynamicallyUnmarshallJSON unmarshals JSON into known and dynamic fields.
//
// Steps:
...
func DynamicallyUnmarshallJSON(data []byte, dynamic DynamicRepresentation) error {

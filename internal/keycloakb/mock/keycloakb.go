...
// GetContextKeyConfiguration mocks base method.
func (m *ConfigurationDBModule) GetContextKeyConfiguration(ctx context.Context, customerRealm string) ([]configuration.RealmContextKey, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetContextKeyConfiguration", ctx, customerRealm)
	ret0, _ := ret[0].([]configuration.RealmContextKey)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetContextKeyConfiguration indicates an expected call of GetContextKeyConfiguration.
func (mr *ConfigurationDBModuleMockRecorder) GetContextKeyConfiguration(ctx, customerRealm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetContextKeyConfiguration", reflect.TypeOf((*ConfigurationDBModule)(nil).GetContextKeyConfiguration), ctx, customerRealm)
}
...
func (m *ContextKeyLoader) GetContext(realm, contextKey string) (configuration.RealmContextKey, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetContext", realm, contextKey)
	ret0, _ := ret[0].(configuration.RealmContextKey)
	ret1, _ := ret[1].(bool)
	return ret0, ret1
}
...
func (mr *ContextKeyLoaderMockRecorder) GetContext(realm, contextKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetContext", reflect.TypeOf((*ContextKeyLoader)(nil).GetContext), realm, contextKey)
}

// GetContextByCustomerRealm mocks base method.
func (m *ContextKeyLoader) GetContextByCustomerRealm(customerRealm string) (configuration.RealmContextKey, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetContextByCustomerRealm", customerRealm)
	ret0, _ := ret[0].(configuration.RealmContextKey)
	ret1, _ := ret[1].(bool)
	return ret0, ret1
}
...
func (mr *ContextKeyLoaderMockRecorder) GetContextByCustomerRealm(customerRealm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetContextByCustomerRealm", reflect.TypeOf((*ContextKeyLoader)(nil).GetContextByCustomerRealm), customerRealm)
}

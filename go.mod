...
require (
	github.com/cloudtrust/common-service/v2 v2.5.12-0.20220807160956-9b9f250f0eb0
	github.com/cloudtrust/httpclient v1.0.7
	github.com/cloudtrust/keycloak-client/v2 v2.5.8-0.20220807161236-514429920cfa

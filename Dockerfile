FROM docker.artifactory.svc.elca.ch/redhat/ubi8-minimal:8.10-1759911539 AS build-env
...
FROM docker.artifactory.svc.elca.ch/redhat/ubi8-micro:8.10-1760514998

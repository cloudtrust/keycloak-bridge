FROM docker.artifactory.svc.elca.ch/redhat/ubi8-minimal:8.10-1756195339 AS build-env
...
FROM docker.artifactory.svc.elca.ch/redhat/ubi8-micro:8.10-1758718872

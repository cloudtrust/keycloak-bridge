FROM docker.artifactory.svc.elca.ch/redhat/ubi8-minimal:8.10-1295.1749680713 AS build-env
...
FROM docker.artifactory.svc.elca.ch/redhat/ubi8-micro:8.10-26

FROM docker.artifactory.svc.elca.ch/redhat/ubi8-minimal:8.10-1179.1739286367 AS build-env
...
FROM docker.artifactory.svc.elca.ch/redhat/ubi8-micro:8.10-20.1739286373

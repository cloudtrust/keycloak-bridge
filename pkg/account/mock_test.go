...
//go:generate mockgen -destination=./mock/account_keycloak_client.go -package=mock -mock_names=KeycloakAccountClient=KeycloakAccountClient,UsersDBModule=UsersDBModule github.com/cloudtrust/keycloak-bridge/pkg/account KeycloakAccountClient,UsersDBModule

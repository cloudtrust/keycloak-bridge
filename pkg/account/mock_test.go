...
//go:generate mockgen -destination=./mock/component.go -package=mock -mock_names=Component=Component,GlnVerifier=GlnVerifier github.com/cloudtrust/keycloak-bridge/pkg/account Component,GlnVerifier

...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock/component.go -package=mock -mock_names=Component=Component,UserProfileCache=UserProfileCache github.com/cloudtrust/keycloak-bridge/pkg/account Component,UserProfileCache

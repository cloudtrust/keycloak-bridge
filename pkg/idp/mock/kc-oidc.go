...
// Source: github.com/cloudtrust/keycloak-client/v2/toolbox (interfaces: OidcTokenProvider,ComponentTool)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -destination=./mock/kc-oidc.go -package=mock -mock_names=OidcTokenProvider=OidcTokenProvider,ComponentTool=ComponentTool github.com/cloudtrust/keycloak-client/v2/toolbox OidcTokenProvider,ComponentTool
//

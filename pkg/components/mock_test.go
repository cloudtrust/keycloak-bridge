...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock/keycloak_component_client.go -package=mock -mock_names=KeycloakComponentClient=KeycloakComponentClient,Component=Component github.com/cloudtrust/keycloak-bridge/pkg/components KeycloakComponentClient,Component

...
type KeycloakClient interface {
	...
	GetCredentialsForUser(accessToken string, realmName string, userID string) ([]api.CredentialRepresentation, error)
	DeleteCredentialsForUser(accessToken string, realmName string, userID string, credentialID string) error
...
func (c *component) GetCredentialsForUser(ctx context.Context, realmName string, userID string) ([]api.CredentialRepresentation, error) {
	...
	return c.keycloakClient.GetCredentialsForUser(accessToken, realmName, userID)
}

func (c *component) DeleteCredentialsForUser(ctx context.Context, realmName string, userID string, credentialID string) error {
	var accessToken = ctx.Value("access_token").(string)

	return c.keycloakClient.DeleteCredentialsForUser(accessToken, realmName, userID, credentialID)
}

...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock/management.go -package=mock -mock_names=Component=ManagementComponent,KeycloakClient=KeycloakClient,OnboardingModule=OnboardingModule,GlnVerifier=GlnVerifier github.com/cloudtrust/keycloak-bridge/pkg/management Component,KeycloakClient,OnboardingModule,GlnVerifier

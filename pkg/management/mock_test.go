...
//go:generate mockgen -destination=./mock/usersdbmodule.go -package=mock -mock_names=UsersDBModule=UsersDBModule github.com/cloudtrust/keycloak-bridge/pkg/management UsersDBModule

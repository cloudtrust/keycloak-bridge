...
// Source: github.com/cloudtrust/keycloak-bridge/pkg/mobile (interfaces: KeycloakClient,AuthorizationManager,RoleBasedAuthorizationManager)
//
...
func (m *RoleBasedAuthorizationManager) CheckRoleAuthorizationOnTargetUser(ctx context.Context, initIdentAction, targetRealm, userID string) error {
	m.ctrl.T.Helper()
...
func (mr *RoleBasedAuthorizationManagerMockRecorder) CheckRoleAuthorizationOnTargetUser(ctx, initIdentAction, targetRealm, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckRoleAuthorizationOnTargetUser", reflect.TypeOf((*RoleBasedAuthorizationManager)(nil).CheckRoleAuthorizationOnTargetUser), ctx, initIdentAction, targetRealm, userID)
}

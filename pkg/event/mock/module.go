...
func (m *ConsoleModule) Print(arg0 context.Context, arg1 map[string]interface{}) error {
...
func (m *StatisticModule) Stats(arg0 context.Context, arg1 map[string]interface{}) error {

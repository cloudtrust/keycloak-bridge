...
func TestEventToMap(t *testing.T) {
	...
	assert.Equal(t, time.Unix(0, epoch*1000000).UTC().Format(time.RFC3339), m["audit_time"])
...
func TestAdminEventToMap(t *testing.T) {
	...
	assert.Equal(t, time.Unix(0, epoch*1000000).UTC().Format(time.RFC3339), m[database.CtEventAuditTime])

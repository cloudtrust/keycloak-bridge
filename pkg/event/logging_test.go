...
func TestMuxComponentLoggingMW(t *testing.T) {
	...
	mockLogger.EXPECT().Info(ctx, "unit", "Event", "type", "Event", "correlation_id", corrID, "took", gomock.Any()).Times(1)
...
func TestComponentLoggingMW(t *testing.T) {
	...
	mockLogger.EXPECT().Info(ctx, "unit", "Event", "correlation_id", corrID, "took", gomock.Any()).Times(1)
	m.Event(ctx, event)
...
func TestAdminComponentLoggingMW(t *testing.T) {
	...
	mockLogger.EXPECT().Info(ctx, "unit", "AdminEvent", "correlation_id", corrID, "took", gomock.Any()).Times(1)
...
func TestConsoleModuleLoggingMW(t *testing.T) {
	...
	mockLogger.EXPECT().Debug(ctx, "method", "Print", "args", mp, "took", gomock.Any()).Times(1)
	m.Print(ctx, mp)
}
...
func TestStatisticModuleLoggingMW(t *testing.T) {
	...
	mockLogger.EXPECT().Debug(ctx, "method", "Stats", "args", mp, "took", gomock.Any()).Times(1)
	m.Stats(ctx, mp)
}
...
func TestEventsDBModuleLoggingMW(t *testing.T) {
	...
	mockLogger.EXPECT().Debug(ctx, "method", "Store", "args", mp, "took", gomock.Any()).Times(1)
	m.Store(ctx, mp)
}

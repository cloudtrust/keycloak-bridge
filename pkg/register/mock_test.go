...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock/register.go -package=mock -mock_names=Component=Component,KeycloakClient=KeycloakClient,ConfigurationDBModule=ConfigurationDBModule,ContextKeyManager=ContextKeyManager,OnboardingModule=OnboardingModule,UserProfileCache=UserProfileCache github.com/cloudtrust/keycloak-bridge/pkg/register Component,KeycloakClient,ConfigurationDBModule,ContextKeyManager,OnboardingModule,UserProfileCache

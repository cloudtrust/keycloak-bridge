...
func (m *Component) UpdateUserAccreditations(ctx context.Context, realmName, userID string, userAccreds []apivalidation.AccreditationRepresentation, sponsors *string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUserAccreditations", ctx, realmName, userID, userAccreds, sponsors)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateUserAccreditations indicates an expected call of UpdateUserAccreditations.
func (mr *ComponentMockRecorder) UpdateUserAccreditations(ctx, realmName, userID, userAccreds, sponsors any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateUserAccreditations", reflect.TypeOf((*Component)(nil).UpdateUserAccreditations), ctx, realmName, userID, userAccreds, sponsors)
}

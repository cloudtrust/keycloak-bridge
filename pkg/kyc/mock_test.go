...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock/kyc.go -package=mock -mock_names=Component=Component,KeycloakClient=KeycloakClient,EventsDBModule=EventsDBModule,ArchiveDBModule=ArchiveDBModule,ConfigDBModule=ConfigDBModule,GlnVerifier=GlnVerifier github.com/cloudtrust/keycloak-bridge/pkg/kyc Component,KeycloakClient,EventsDBModule,ArchiveDBModule,ConfigDBModule,GlnVerifier

...
// Source: github.com/cloudtrust/common-service/v2/database/sqltypes (interfaces: SQLRow,Transaction)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -destination=./mock/sqltypes.go -package=mock -mock_names=SQLRow=SQLRow,Transaction=Transaction github.com/cloudtrust/common-service/v2/database/sqltypes SQLRow,Transaction
//

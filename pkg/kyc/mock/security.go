...
// Source: github.com/cloudtrust/common-service/v2/security (interfaces: AuthorizationManager,IdentificationAuthorizationManager)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -destination=./mock/security.go -package=mock -mock_names=AuthorizationManager=AuthorizationManager,IdentificationAuthorizationManager=IdentificationAuthorizationManager github.com/cloudtrust/common-service/v2/security AuthorizationManager,IdentificationAuthorizationManager
//
...
func (m *IdentificationAuthorizationManager) CheckRoleAuthorizationOnSelfUser(ctx context.Context, action string) error {
	m.ctrl.T.Helper()
...
func (mr *IdentificationAuthorizationManagerMockRecorder) CheckRoleAuthorizationOnSelfUser(ctx, action any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckRoleAuthorizationOnSelfUser", reflect.TypeOf((*IdentificationAuthorizationManager)(nil).CheckRoleAuthorizationOnSelfUser), ctx, action)
}

// CheckRoleAuthorizationOnTargetUser mocks base method.
func (m *IdentificationAuthorizationManager) CheckRoleAuthorizationOnTargetUser(ctx context.Context, action, targetRealm, userID string) error {
	m.ctrl.T.Helper()
...
func (mr *IdentificationAuthorizationManagerMockRecorder) CheckRoleAuthorizationOnTargetUser(ctx, action, targetRealm, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckRoleAuthorizationOnTargetUser", reflect.TypeOf((*IdentificationAuthorizationManager)(nil).CheckRoleAuthorizationOnTargetUser), ctx, action, targetRealm, userID)
}
